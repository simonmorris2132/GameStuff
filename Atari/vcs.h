...
; available at at httpwww.atari2600.orgdasm
;
...
;
; Latest Revisions...
; 1.05  13NOV2003      - Correction to 1.04 - now functions as requested by MR.
...
; 1.04  12NOV2003     Added TIA_BASE_WRITE_ADDRESS and TIA_BASE_READ_ADDRESS for
;                       convenient disassemblyreassembly compatibility for hardware
;                       mirrored readingwriting differences.  This is more a 
;                       readability issue, and binary compatibility with disassembled
;                       and reassembled sources.  Per Manuel Rotschkar's suggestion.
; 1.03  12MAY2003     Added SEG segment at end of file to fix old-code compatibility
;                       which was broken by the use of segments in this file, as
;                       reported by Manuel Polik on [stella] 11MAY2003
; 1.02  22MAR2003     Added TIMINT($285)
...
; TIA_BASE_ADDRESS = $40
;   include vcs.h
; Alternate readwrite address capability - allows for some disassembly compatibility
; usage ; to allow reassembly to binary perfect copies).  This is essentially catering
; for the mirrored ROM hardware registers.
; Usage As per above, define the TIA_BASE_READ_ADDRESS andor TIA_BASE_WRITE_ADDRESS
...
NUSIZ0		ds 1	; $04   00xx 0xxx   Number-Size playermissle 0
NUSIZ1		ds 1	; $05   00xx 0xxx   Number-Size playermissle 1
...
TIMINT  	ds 1	; $285
		; Unusedundefined registers ($285-$294)
			ds 1	; $286
			ds 1	; $287
			ds 1	; $288
			ds 1	; $289
